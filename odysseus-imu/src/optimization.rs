...
mod tests {
    use super::*;
    use crate::simulator::{add_timestamps_to_poses, ImuNoiseParams};
    use crate::{ImuSimulator, PreintegratedImu};
    use crate::{ContinuousCircularTrajectory, ContinuousTrajectory};
